    ...
    <div class=midish>
      ...
      <div class=header2>COVERING THE NATION</div>
		...
		<ul id=nav>
			...
			<li><div class=thispage>contact</div>
...
?>
      ...
      <div class=midheader2>CONTACT US</div>
      We look forward to hearing from you. Please enter your query below and we'll get back to you promptly.<br><br>
      <form id=contactform name=contactform action=confirmation.php method=post>
        <input type=text name=name placeholder='Name'><br>
        <input type=email name=email placeholder='Email'><br>
        <input type=text name=subject placeholder='Subject'><br>
        <textarea rows=8 name=content placeholder='enter comments here...'></textarea>
